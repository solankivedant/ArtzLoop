 ...
 * eraser: this toy repaints its whole board fresh from `frames` every
...
window.TOY = {
  ...
  customEraser: true, // this toy erases by clearing a grid cell, not canvas pixels - see header comment
  params:[
...
// Grid + Speed behind the Frame-settings icon), the same pattern a toy would
 ...
 * toy handles its own pixel-grid eraser in T.pointer() instead. */
